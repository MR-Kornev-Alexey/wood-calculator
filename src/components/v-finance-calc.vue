        ...
        <v-row class="d-flex">
            ...
            <div class="md-2 block-grey ">
                ...
                <div class="my-4">
                    ...
                    <div class="out-data" v-show="flagRender">{{ overCalc }} рублей</div>
                </div>
                <div class="my-4">
                    <div style="height: 40px">
                        <h3>
                    ...
                    <div class="out-data" v-show="flagRender">{{ rateCalc }} рублей</div>
                </div>
                <div class="my-4">
                    <div style="height: 40px">
                        <h3>
                    ...
                    <div class="out-data" v-show="flagRender">
...
<style lang="scss">
    ...
    input[type="range"]::-webkit-slider-thumb {
        ...
        box-shadow: 1px 1px 1px #13351c, 0 0 1px #14361d;
